...
class RealProperty:
    ...
    def price_difference(self, compared_to):
        ...
        self_value = self.price_per_sqm * self.square_metres 
        compare_value = compared_to.price_per_sqm * compared_to.square_metres
        if self_value >= compare_value:
            return self_value - compare_value
        return compare_value - self_value
